...
plt.title('Conf. B')
plt.savefig('Rb_B.png',bbox_inches='tight')
...
plt.title('Conf. B')
plt.savefig('tBL_B.png',bbox_inches='tight')
...
plt.title('Conf. B')
plt.savefig('theta_B.png',bbox_inches='tight')

#        plt.savefig(path.join(FIGDIR, 'theta_'+KEY+'.png'))        
