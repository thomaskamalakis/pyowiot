...
from libow3 import plot_on_grid, spectra, constants, sensor_net, grid_of_points, aligned_to, sensor_consumption, interp_on_grid
...
plt.colorbar()
plt.axis('equal')
plt.savefig(HOME_DIR + 'SNRd_1.png')
...
plt.savefig(HOME_DIR + 'tBL1.png',
            bbox_extra_artists=[lgd], bbox_inches='tight')

# Further downlink staff
plt.figure()
